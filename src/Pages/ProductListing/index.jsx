    ...
    <section className="productListing">
      ...
      <div className="container mx-auto px-6 mt-8">
        <div className="flex gap-6">
          {/* SIDEBAR */}
          <div className="w-[22%] sidebarWrapper">
            <Sidebar />
          </div>
          ...
          <div className="w-[78%] productArea">
            ...
            <div className="productTopBar">
              ...
              <div className="col2">
                ...
                <Button onClick={handleOpenMenu} className="sortBtn">
                  Sort By
                </Button>

                <Menu anchorEl={anchorEl} open={open} onClose={handleCloseMenu}>
                  <MenuItem onClick={handleCloseMenu}>Latest</MenuItem>
            ...
            {/* TITLE */}
            <h2 className="text-[26px] font-bold text-white mt-6">
              Software Products
            </h2>
