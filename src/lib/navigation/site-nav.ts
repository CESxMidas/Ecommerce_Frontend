...
export const SHOP_QUICK_LINKS: NavLinkItem[] = [
  ...
  { href: "/products?category=hardware", label: "Phần cứng", icon: Monitor },
];
...
export const SHOP_NAV_GROUP: NavDropdownGroup = {
  ...
  items: [
    ...
    { href: "/deals", label: "Ưu đãi", icon: Tag, match: "prefix" },
    ...SHOP_QUICK_LINKS,
  ],
};
...
export const TRACK_ORDER_NAV_ITEM: NavLinkItem = {
  href: "/track-order",
  label: "Tra cứu đơn",
  icon: PackageSearch,
  match: "prefix",
...
export const SUPPORT_NAV_GROUP: NavDropdownGroup = {
  ...
  items: [
    ...
    { href: "/track-order", label: "Tra cứu đơn", icon: PackageSearch, match: "prefix" },
    {
    ...
    { href: "/support/returns", label: "Chính sách hoàn tiền", icon: Headphones, match: "prefix" },
  ],
};
